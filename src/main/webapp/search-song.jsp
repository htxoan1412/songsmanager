            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap">
                        ...
                        <form action="<%=request.getContextPath()%>/admin/song/search" method="get">
                            <div class="input-group">
                                <div class="form-outline" style="display: inline-block">
                                    <input id="search-input" type="text" id="form1" class="form-control" name ="txtname" value="${txtname}"/>
                                </div>
                                <button type="submit" style="display: inline-block;margin-bottom: 25px;margin-left: 20px"
                        ...
                        <div class="asset-inner">
                            <table>
                                <tr>
                                    ...
                                    <th>Tên bài hát
                                        <a
                                                href="<%=request.getContextPath()%>/admin/song/search?txtname=${txtname}&page=${songs.page}&maxPageItem=${songs.maxPageItem}&sortName=name&sortBy=asc">
                                ...
                                <%
                                    //show song theo tên
                                    ArrayList<SongModel> list =(ArrayList) request.getAttribute("listSong");
                        ...
                        <form id="formSubmit" action="<%=request.getContextPath()%>/admin/song/search" method="get">
